...
var QueryGenerator = {
  ...
  bulkInsertQuery: function(tableName, attrValueHashes, options, rawAttributes) {
    ...
    if (options.updateOnDuplicate) {
      onDuplicateKeyUpdate += ' ON CONFLICT ON CONSTRAINT '+tableName+'_pkey DO UPDATE SET ' + options.updateOnDuplicate.map(function(attr) {
      ...
      onDuplicateKeyUpdate = " ON CONFLICT DO NOTHING";
    }
